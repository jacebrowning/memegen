...
FONT_TINY = FONTS_DIRECTORY / os.getenv("WATERMARK_FONT", "Segoe UI Bold.ttf")
...
DISABLED_WATERMARK = ALLOWED_WATERMARKS.pop(0) or "blank"
DEFAULT_WATERMARK = ALLOWED_WATERMARKS[0]
ALLOWED_WATERMARKS = [x.lower() for x in ALLOWED_WATERMARKS]

WATERMARK_HEIGHT = int(os.getenv("WATERMARK_HEIGHT", 13))
